        ...
        <LangContext.Provider value={{ langType, updateLangType }}>
          <div style={{ marginTop: '-5vw' }}>
            <PromptContext.Provider value={{ prompt, updatePrompt }}>
              ...
              <div className='mx-auto mb-8 w-3/4 rounded-lg bg-white p-8'>
                <div className='mb-12'>
                  <ul className='grid w-full gap-6 md:grid-cols-3'>
                    <li>
                      <input type='checkbox' id='react-option' value='' className='peer hidden' />
                      <label
                      ...
                      >
                        <div className='block'>
                          ...
                          <div className='w-full text-lg font-semibold'>Javascript into Typescript.</div>
                          <div className='w-full text-sm'>Translate from Javascript into Typescript.</div>
                        </div>
                      </label>
                    </li>
                    <li>
                ...
                {/* <ul className='list-reset flex h-10 rounded-3xl'>
                    <li className='mr-1'>
                      <button
                        ...
                        className={`${
                          isPromptVisible && 'bg-white text-gray-800 dark:border-gray-900 dark:bg-gray-900 dark:text-white'
