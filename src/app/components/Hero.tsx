...
export function Hero() {
  ...
  return (
    <section className='bg-gray-800 pb-20 dark:bg-gray-900 md:mb-20'>
      <div className='mx-auto max-w-screen-xl py-8 px-4 text-center lg:py-16 lg:px-12'>
        ...
        <div className='mb-8 flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4 lg:mb-16'>
          <span className='inline-flex items-center justify-center rounded-lg border border-blue-600 bg-blue-600 py-3 px-5 text-center text-base font-medium text-white focus:ring-4 focus:ring-gray-100 hover:bg-blue-600 dark:border-gray-700 dark:text-white dark:focus:ring-gray-800 dark:hover:bg-gray-700'>
        ...
        <div className='mx-auto px-4 text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36'>
          <span className='font-semibold uppercase text-gray-100'>SUPPORT LANGUAGES</span>
